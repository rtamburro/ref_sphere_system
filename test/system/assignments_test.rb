...
class AssignmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Assignment" do
    ...
    fill_in "Assistant referee 1", with: @assignment.assistant_referee_1_id
    fill_in "Assistant referee 2", with: @assignment.assistant_referee_2_id
    fill_in "Center referee", with: @assignment.center_referee_id
    fill_in "Fourth official", with: @assignment.fourth_official_id
